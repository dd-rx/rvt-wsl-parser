...
this _**will**_ be a script to make the revit worksharingjournal human-readable by either simply exporting the revit worksharing
log as a .csv file that can be analyzed in excel or show some quick summaries in the console.

the current state of testing can be seen in the `testing` branch.
